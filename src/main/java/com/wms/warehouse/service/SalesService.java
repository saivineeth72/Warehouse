...
public class SalesService {
    ...
    public List<Integer> getMonthlySales(String productName) {
        ...
        LocalDate sixMonthsAgo = now.minusMonths(36);
    ...
    public List<Integer> getMonthlySales(String productName, String brand, String supplierName) {
        LocalDate now = LocalDate.now();
        LocalDate sixMonthsAgo = now.minusMonths(6);
        List<Object[]> results = salesHistoryRepository.findMonthlySalesByProductBrandSupplier(productName, brand, supplierName);
        List<Integer> monthlySales = new ArrayList<>();
        for (Object[] row : results) {
            Object monthObj = row[0];
            LocalDate monthDate;
    ...
    public int predictNextMonthDemand(String productName, String brand, String supplierName) {
        List<Integer> history = getMonthlySales(productName, brand, supplierName);
        System.out.println("Sales history for " + productName + ", " + brand + ", " + supplierName + ": " + history);
